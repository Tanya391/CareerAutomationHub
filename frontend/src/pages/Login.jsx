...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err || 'Failed to sign in. Check your credentials.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-slate-900/60 border border-slate-800 backdrop-blur-md p-8 rounded-2xl shadow-xl shadow-black/40 relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-xs mt-1.5 font-medium">Log in to check your job automation scanner results</p>
        </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full pl-10 pr-4 py-2.5 bg-slate-950 border border-slate-800 focus:border-brand-500 rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-brand-500/20 transition-all placeholder-slate-600 text-slate-200"
